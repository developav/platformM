  ...
  const handleShowSettings = () => {
    ...
    return (
        <div className="container">
            <h2 className="account__heading">Мой аккаунт</h2>
            <ul className="account__group">
                <li className="account__group-link" onClick={handleShowFavorites}>
                ...
                <li className="account__group-link" onClick={handleShowSettings}>
            ...
            {showFavorites && <AccountFavorites />}

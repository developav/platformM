...
const RandomMovie = () => {
    ...
    const { movie, loading } = useSelector(state  => state.movie); // Получаем данные из Redux
            ...
            <div className='home__container'>
                <div className='grid__home-group'>
                    ...
                    <div className='home__group-button'>
                        {movie.trailerUrl && (
                            <a className='home__play' onClick={openModal} target="_blank" rel="noopener noreferrer">Трейлер</a>
                        )}
                        <a onClick={() => handleMovieDetailsClick(movie.id)} className='home__about'>О фильме</a>
                        ...
                        <a className='home__refresh' onClick={loading ? undefined : fetchMovie}>
